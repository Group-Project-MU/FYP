# 🖧Advanced Nmap Scanner [Link](https://github.com/Group-Project-MU/FYP)
...
- 👉**One click functions**
  ...
  - ✍️**Custom Scan**: run custom Nmap arguments / scripts.
- 📖**Readable outputs**
...
- **Python 3.8+**
- **Nmap**
  - Windows: download from [Nmap](https://nmap.org/download.html)
...
pip --version
```
You may also check your installed libraries through 
```bash
pip list
```
